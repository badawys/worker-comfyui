...
The Docker build compiles a CUDA-enabled `llama-cpp-python >= 0.3.46` wheel in a separate CUDA 12.6 builder stage, so the production image remains based on the CUDA 12.6 runtime.
